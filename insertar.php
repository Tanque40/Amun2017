...
//***************************************SELECCIONA EL PHP*****************
    ...
    $selec=$_POST["delegadocase"];
        ...
        $sex=$_POST["sex"];
        $enlace=$comite."dat";
        $dele=$_POST["delegation"]
        $numpeople=$_POST["numpeople"];

    if ($selec && $comite && $app && $apm && $born && $tel && $correo && $pass && $pros && $gruesc && $pais && $sex && $delegation && $numpeople){
        echo "llenos"
    }
  ...
  /*  if $selec == "Delegado"{ 
    //***************************************LECTURA DE VARIABLES*****************************************
        ...
        //******************************SI TU CORREO NO ESTA EN LA BD SIGUE PROCESO E INSERTA LOS DATOS**************************
            ...
            $prueba = "INSERT INTO $comite VALUES ('$nombre','$app','$apm','$born','$tel','$correo','$pros','$gruesc','$pais','$sex')";
            $prueba2 = "INSERT INTO DatosAcc VALUES ('$correo','$pass','SC','$comite','$enlace')";    
            $prueba3 = "INSERT INTO $enlace VALUES ('Aún no se ha efectuado el pago','¡Debes realizar el pago! País sin confirmar','0','0','$correo')";  
                //ESTO ES CONSULTA EN SQL

            
            //******************AQUI SOLO COMPRUEBA QUE LA CONSULTA SE REALIZO DE MANERA CORRECTA
            if(mysqli_query($con, $prueba3)){
            ...
            if(mysqli_query($con, $prueba)){
                ...
                Te informamos que tu registro en AMUN 2017 se ha completado exitosamente en $comite.
                <br><br> 
                BANCO BANORTE
                No. DE CUENTA: 0671221393
                CLAVE INTERBANCARIA: 072180006712213930
                REFERENCIA: 072017
                <br><br>
    ...
    elseif $selec=="Paje"{
        ...
        //******************************SI TU CORREO NO ESTA EN LA BD SIGUE PROCESO E INSERTA LOS DATOS**************************
            ...
            $prueba = "INSERT INTO $comite VALUES ('$nombre','$app','$apm','$born','$tel','$correo','$pros','$gruesc','$dele', '$numpeople','$sex')";
            $prueba2 = "INSERT INTO DatosAcc VALUES ('$correo', '', 'SC','$comite')";
