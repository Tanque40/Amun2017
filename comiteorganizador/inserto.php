...
$result = mysqli_query($con, "SELECT correo FROM ComiteOrg Where correo = '$correo'");
...
$prueba = "INSERT INTO ComiteOrg VALUES ('$Nombre','$ApPat','$ApMat','$Tel','$correo','$Sexo','$Tipo','$Grupo')"; //ESTO ES CONSULTA EN SQL
